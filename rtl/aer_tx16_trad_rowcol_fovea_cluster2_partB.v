...
// 실험으로 취급해야 한다.
module aer_tx16_trad_rowcol_fovea_cluster2_partB (
  // row partition B: {0,2} / {1,3} (vs 현재 채택된 partition C: {0,3}/{1,2})
  input         clk,
  input         rst,
  input  [15:0] req,
  ...
  localparam [3:0] CENTER_MASK = 4'b0101; // 행0,행2
  localparam [3:0] PERIPH_MASK = 4'b1010; // 행1,행3
