// cluster2(2레인) 정확성 검증 -- tb_cluster_correctness.v와 동일한 방법론, 레인 2개로 확장.
`timescale 1ns/1ps
module tb_cluster2_correctness;
  parameter N = 16;
  ...
  initial begin
    ...
    if (error_count == 0)
      $display("CLUSTER2_CORRECTNESS_PASS");
    else
      $display("CLUSTER2_CORRECTNESS_FAIL errors=%0d", error_count);
    $finish;
  end
endmodule
