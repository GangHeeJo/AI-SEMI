...
module tb_quarantine_cyc04;
  ...
  initial begin
    ...
    for (cyc = 0; cyc < 5; cyc = cyc + 1) begin
      ...
      #1;
      $display("cyc%0d arrival=%b overrun=%b collide=%b accept_one=%b picked=%0d pending_pre=%b granted_bitmap=%b",
        cyc, arrival, overrun_w, dut.collide, dut.accept_one, dut.picked, dut.pending_bits, dut.granted_bitmap);
      @(posedge clk); #1;
      $display("  -> pending=%b qv=%b%b%b%b qa=%0d,%0d,%0d,%0d valid0=%b row0=%0d cm0=%b valid1=%b row1=%0d cm1=%b",
