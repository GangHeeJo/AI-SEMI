// cluster2_dynamic 정확성 검증 -- tb_cluster2_correctness.v와 동일 방법론.
`timescale 1ns/1ps
module tb_cluster2_dynamic_correctness;
  parameter N = 16;
  ...
  aer_tx16_trad_rowcol_fovea_cluster2_dynamic dut(
  ...
  integer generated, delivered, phantom_count, error_count, collision_count;
  integer idx;
  ...
  initial begin
    rst = 1; req = 16'd0;
    generated = 0; delivered = 0; phantom_count = 0; error_count = 0; collision_count = 0;
    score.init;
    @(posedge clk); #1;
    rst = 0;
    ...
    $display("generated=%0d delivered=%0d phantom=%0d collisions=%0d avg_latency=%0d max_latency=%0d jain_x1000=%0d",
      generated, delivered, phantom_count, collision_count, score.avg_latency(0), score.max_lat, score.jain_fairness_x1000(0));

    if (error_count == 0)
      $display("CLUSTER2_DYNAMIC_CORRECTNESS_PASS");
    else
      $display("CLUSTER2_DYNAMIC_CORRECTNESS_FAIL errors=%0d", error_count);
    $finish;
  end
endmodule
