# Four 8x8 AER regions (16x16 pulse aperture), central double-buffered
# region coefficients, and one shared affine lane.  The coefficient array is
# generic RTL memory; this report is not SRAM-macro PPA.

set DESIGN aer_tx256_region_shared_affine
set RTL_LIST {
  rtl/arbiter2.v
  rtl/arbiter4_tree.v
