# cluster2+dense bitmap 하이브리드(§70) Genus 합성. cluster2(138.852um²/11.8744uW,
# critical path 1.21ns @5ns 제약)와 같은 조건으로 비교.
#   genus -batch -files syn/run_genus_hybrid.tcl

set DESIGN   aer_tx16_hybrid_cluster2_bitmap
set RTL_LIST {rtl/arbiter2.v rtl/arbiter4_tree.v rtl/aer_tx16_hybrid_cluster2_bitmap.v}
