# cluster2_steal(work-conserving 2레인, lane stealing) Genus 합성. cluster2(138.852um²/
# 11.8744uW)와 직접 비교하려고 같은 SDC/effort/클록게이팅 사용.
#   genus -batch -files syn/run_genus_cluster2_steal.tcl

set DESIGN   aer_tx16_trad_rowcol_fovea_cluster2_steal
set RTL_LIST {rtl/arbiter2.v rtl/arbiter4_tree.v rtl/aer_tx16_trad_rowcol_fovea_cluster2_steal.v}
