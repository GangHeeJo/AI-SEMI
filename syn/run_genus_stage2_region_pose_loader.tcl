# Full-sensor affine-region configuration sequencer only.  This excludes the
# 690 local coefficient tables, AER datapaths, response mux, and routing fanout;
# report it as control-plane cost, never as total full-sensor PPA.

set DESIGN affine_region_pose_loader
set RTL_LIST {
