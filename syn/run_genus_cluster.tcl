# fovea_cluster(col 중재기 제거, row+col_mask 비트맵 출력) Genus 합성.
# fovea(169.632um²/12.4971uW, 5ns 기준)와 직접 비교하려고 같은 SDC/effort/클록게이팅 사용.
#   genus -batch -files syn/run_genus_cluster.tcl

set DESIGN   aer_tx16_trad_rowcol_fovea_cluster
set RTL_LIST {rtl/arbiter2.v rtl/arbiter4_tree.v rtl/aer_tx16_trad_rowcol_fovea_cluster.v}
