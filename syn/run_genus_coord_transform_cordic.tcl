# Digital 2차 1단계 좌표변환(coord_transform_cordic) Genus 합성 -- baseline(직접 행렬곱)과
# PPA 비교용. syn/run_genus_coord_transform.tcl과 동일 조건(5ns, 같은 라이브러리).
#   genus -batch -files syn/run_genus_coord_transform_cordic.tcl

set DESIGN   coord_transform_cordic
set RTL_LIST {rtl/coord_transform_cordic.v}
