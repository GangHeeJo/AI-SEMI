# cluster2_steal_buf에 극성(polarity) 2-deep FIFO 확장 얹은 버전 Genus 합성.
# cluster2_steal_buf(695.286um²/19.9182uW)와 비교해서 극성 추가의 실제 PPA 비용을 잼.
#   genus -batch -files syn/run_genus_steal_buf_polarity.tcl
