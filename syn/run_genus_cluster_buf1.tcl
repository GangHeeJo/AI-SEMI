# cluster_buf1(1-deep 버퍼) Genus 합성. cluster_buf(2-deep, 650.826um²/43.9977uW)와
# 직접 비교하려고 같은 SDC/effort/클록게이팅 사용.
#   genus -batch -files syn/run_genus_cluster_buf1.tcl

set DESIGN   aer_tx16_trad_rowcol_fovea_cluster_buf1
set RTL_LIST {rtl/arbiter2.v rtl/arbiter4_tree.v rtl/aer_tx16_trad_rowcol_fovea_cluster_buf1.v}
