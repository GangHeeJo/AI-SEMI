# fovea_cluster2(2레인, round 없음) Genus 합성. cluster(146.034um²/10.67uW)와 비교.
#   genus -batch -files syn/run_genus_cluster2.tcl

set DESIGN   aer_tx16_trad_rowcol_fovea_cluster2
set RTL_LIST {rtl/arbiter2.v rtl/arbiter4_tree.v rtl/aer_tx16_trad_rowcol_fovea_cluster2.v}
