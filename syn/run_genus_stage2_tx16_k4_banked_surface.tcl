# Stage-2 K=4 transform plus four-bank external-memory control boundary.
# External SRAM bitcell/macro area is not included in this logic synthesis.

set DESIGN aer_tx16_pose_affine2d_k4_sram_surface
set RUN_NAME ${DESIGN}_d8
set PARAMS {8}
set RTL_LIST {
  rtl/arbiter2.v
  rtl/arbiter4_tree.v
